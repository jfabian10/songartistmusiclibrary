...
public class WorldTest extends TestCase {
    ...
    public void testComplicatedInsert() {
        ...
        assertEquals(6, world.getArtistHash().numOfElts()); /// fix artist
        assertEquals(6, world.getSongHash().numOfElts());
        world.printArtists();
        world.printSongs();
        ...
        assertEquals(11, world.getArtistHash().numOfElts());
        assertEquals(11, world.getSongHash().numOfElts());
        ...
        assertEquals(21, world.getArtistHash().numOfElts());
        assertEquals(21, world.getSongHash().numOfElts());
